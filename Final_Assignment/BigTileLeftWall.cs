...
{
    class BigTileLeftWall : IBigTile
    {
        public Single posX;
        public Single posY;
        public Single width;
        ...
        public BigTileLeftWall(Single newPosX, Single newPosY, Single newWidth, Single newHeight)
        {
            posX = newPosX;
            posY = newPosY;
            width = newWidth;
        ...
        public void Initialize()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ATile = new DrawSpace(currentPosX, currentPosY, width, height);
                tiles[0].Add(ATile);
                currentPosX += width;
            }
            currentPosX = posX;
